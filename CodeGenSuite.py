...
#     #* test visitIf và visitFor
    # def test_9(self):
        ...
        input = """
            ...
            begin
                var a <- -1
                if (a = 1) writeNumber(1)
                elif (a = 2) writeNumber(3)
                elif( a = 3) writeNumber(5)
                else writeNumber(4)
            end
        """
        expect = "4.0"
