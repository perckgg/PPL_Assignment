...
class JasminCode(MachineCode):
    ...
    def emitALOAD(self, in_):#String ,array, class
        # in_: Int
        if in_ >= 0 and in_ <= 3:
    ...
    def emitASTORE(self, in_): #store array
        # in_: Int
        if in_ >= 0 and in_ <= 3:
    ...
    def emitAASTORE(self): #two side array
        return JasminCode.INDENT + "aastore" + JasminCode.END

    def emitIALOAD(self):#load array cell
    ...
    def emitIFACMPEQ(self, label): #compare string, array -> may be
        # label: Int
    ...
    def emitNEW(self, lexeme): #new class, string
        # lexeme: String
        return JasminCode.INDENT + "new " + lexeme + JasminCode.END

    def emitNEWARRAY(self, lexeme): #new array int, float
        # lexeme: String
    ...
    def emitINVOKESTATIC(self, lexeme, typ): # call static function
        # lexeme: String
        # typ: String
    ...
    def emitINVOKEVIRTUAL(self, lexeme, typ): # invoke method in class
        # lexeme: String
        # typ: String
    ...
    def emitLIMITSTACK(self, in_): #limit operand stack
        # in_: Int
    ...
    def emitSTATICFIELD(self, lexeme, typ, isFinal): # initialize a variable
        # lexeme: String
        # typ: String
        # isFinal: Boolean
        if isFinal:
    ...
    def emitIINC(self, index, step):
        return JasminCode.INDENT + "iinc " + str(index) + " " + str(step) + JasminCode.END
